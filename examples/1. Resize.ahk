/*
This example showcases the resizing beaviour of the matrix
it also shows how the matrix looks when it is just created
its the most basic example I could come up with so it is listed first
*/

#Include ../Matrix.ahk

m := new Matrix(3, 3) ;create a new matrix and store it in m
mString0 := m.ToString("Round") ;call the .ToString method to turn the matrix m into a string
...
mString2 := m.ToString("Round") ;call the .ToString method to turn the matrix m into a string

m.resize(2, 2) ;resize the matrix m
mString3 := m.ToString("Round") ;call the .ToString method to turn the matrix m into a string

m.resize(5, 5) ;resize the matrix m
mString4 := m.ToString("Round") ;call the .ToString method to turn the matrix m into a string
