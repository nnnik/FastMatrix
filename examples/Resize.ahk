...
m.fillRandom(10, 99)  ;fill m1 with random integers from 10 to 99
...
Msgbox % "create a matrix m with the size 3, 3 `n" . mString0 . "`n`nfill it with random data:`n" . mString . "`n`nresize it to 5, 5:`n" . mString2 . "`n`nresize it to 2, 2:`n" . mString3 . "`n`nand resize it back to 5, 5 - notice how the matrix only contains the data from the 2, 2 matrix:`n" . mString4